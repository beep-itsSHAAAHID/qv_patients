...
// https://twitter.com/JeanmartinPV

// exact source - https://github.com/JeanmartinPV/sample_application_flutter/blob/master/jpv_flutter/lib/src/ui/onboarning/feature/widget/custom_background.dart
...
class OnBoardingBackground extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    canvas.drawShadow(path, const Color(0xFFb0c7ff), 30, false);
